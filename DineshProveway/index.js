...
LineBreak.setAttribute("width", "90%");
LineBreak.classList.add("line-break");
HiddenCard.appendChild(LineBreak);
...
const MostPopularEl = document.createElement("p");
MostPopularEl.classList.add("most-popular");
MostPopularEl.textContent = mostPopular;
MostPopularDiscountCard.appendChild(MostPopularEl);

const DiscountEl = document.createElement("p");
DiscountEl.classList.add("discount-percentage");
DiscountEl.textContent = discount;
MostPopularDiscountCard.appendChild(DiscountEl);
